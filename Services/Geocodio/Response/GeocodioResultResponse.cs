...
namespace Xcalibur.Weather.Models.Services.Geocodio.Response
{
    ...
    /// </summary>
    public sealed class GeocodioResultResponse
    {
        /// <summary>
        ...
        public GeocodioResultAddressComponentsResponse? AddressComponents { get; init; }
        ...
        public GeocodioLocationResponse? Location { get; init; }
