...
{
    /// <summary>
    /// Astronomy data response model representing various celestial events and measurements.
    /// </summary>
    public class AstronomyResponse
    {
        ...
        public MorningEveningResponse? Morning { get; set; }
        ...
        public MorningEveningResponse? Evening { get; set; }
